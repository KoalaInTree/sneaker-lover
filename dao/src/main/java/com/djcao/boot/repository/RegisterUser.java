...
public class RegisterUser  implements java.io.Serializable {
    ...
    public RegisterUser(Date createTime, Date updateTime, String identityNumber, String phoneNumber, String email, Long userId, Long groupId, String name, String ext) {
